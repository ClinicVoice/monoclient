...
export const AppointmentDetailsPanel: React.FC<AppointmentRecordRequestDetailsPanelProps> = ({
    appointment,
    onClose,
}) => {
    const { setToaster } = useToaster();
    const [isEditing, setIsEditing] = useState(false);
    const [formData, setFormData] = useState<AppointmentRead>(appointment);
